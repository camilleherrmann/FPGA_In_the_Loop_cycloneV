...
## Set clock groups ##
set_clock_groups -exclusive -group {u_ClockManager|u_dcm|auto_generated|generic_pll1~PLL_OUTPUT_COUNTER|divclk} -group {u_ClockManager|u_dcm|auto_generated|generic_pll2~PLL_OUTPUT_COUNTER|divclk} -group {ETH_RXCLK} 
